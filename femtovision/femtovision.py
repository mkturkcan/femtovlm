...
class MultiModalModel(nn.Module):
    ...
    def forward(self, batch):
        ...
        for i in range(batch_size):
            ...
            tokenized_prompt = self._embed_tokens(self.language_tokenizer.encode(prompt_samples[i], return_tensors="pt")).squeeze(0) # self.language_tokenizer(prompt_samples[i], return_tensors="pt")['input_ids']      
